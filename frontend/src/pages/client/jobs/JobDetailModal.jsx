    ...
    <div className="job-modal-overlay">
      <div className="job-modal" role="dialog">
        <div className="job-modal__header">
          <h2>{job.title}</h2>
          <button onClick={onClose} className="job-modal__close" aria-label="Đóng">
        ...
        <div className="job-modal__body custom-scrollbar">
          <div className="job-modal__grid">
            <div className="job-modal__box">
              ...
              <div className="job-modal__box-value">{job.id}</div>
            </div>
            
            <div className="job-modal__box">
              <div className="job-modal__box-label">Trạng thái tuyển dụng</div>
              <div className={`job-modal__status ${job.status ? 'job-modal__status--open' : 'job-modal__status--closed'}`}>
          ...
          <div>
            ...
            <div className="job-modal__tags-wrap">
              {job.requirements?.length > 0 ? (
                ...
                <span className="job-modal__empty-text">Không có yêu cầu kỹ năng cụ thể.</span>
              )}
            </div>
          </div>
