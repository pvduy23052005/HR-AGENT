...
import { GetStatisticsUseCase } from '../../../../application/use-cases/client/report/get-statistics.use-case';

export class ReportController {
  private getStatisticsUseCase: GetStatisticsUseCase;

  constructor() {
    this.getStatisticsUseCase = new GetStatisticsUseCase();
  }
  ...
  getStatistics = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const reportData = await this.getStatisticsUseCase.execute(
        userId.toString(),
